'use strict';(function(){const searchDataURL='/en.search-data.min.f6d65391816d503909430d88f2e74b014a579c13fe55d0783b7ecb07ce40ee33.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
