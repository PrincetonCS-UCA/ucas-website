'use strict';(function(){const searchDataURL='/en.search-data.min.f41fc1317b87345657391b6ecc8258c0fdea74eb54c459537f0216b30f5bb057.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
